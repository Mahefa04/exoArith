package com.app.arith.endpoint.event.consumer;

import com.app.arith.PojaGenerated;
import com.app.arith.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.app.arith.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.app.arith.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
